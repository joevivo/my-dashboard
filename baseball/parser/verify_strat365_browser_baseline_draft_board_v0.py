...
from baseball.parser.report_strat365_browser_baseline_draft_board_v0 import (
    best_park,
    descriptor,
    player_line,
    salary,
...
def main() -> int:
    ...
    require(score(hitter["browserBaselineDraftScore"]) == 51.25, "score mismatch")
    require(salary(hitter) == 2.5, "hitter salary mismatch")
    require(spread(hitter) == 7.75, "hitter spread mismatch")
    require(best_park(hitter) == "Best Park 1968", "best park mismatch")
    require(worst_park(hitter) == "Worst Park 1968", "worst park mismatch")
    ...
    require("global 42" in hitter_line, "hitter line missing rank")
    require("score 51.25" in hitter_line, "hitter line missing score")
    require("spread 7.75" in hitter_line, "hitter line missing spread")
    ...
    require("best Pitcher Park 1968" in pitcher_line, "pitcher line missing best park")

    print("PASS: Strat365 browser-baseline draft-board report smoke verification")
    print(hitter_line)
    print(pitcher_line)
    return 0
