...
def main() -> int:
    ...
    lines: list[str] = [
        ...
        "",
        "Generated from card-backed hitter and starter recommendation overlays.",
        "",
        "## Readiness Summary",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "- Rebuild one legal roster scenario using these overlays.",
            "- Confirm at least 2 primary catchers.",
            "- Confirm at least 5 starter-endurance pitchers.",
            "- Confirm at least 4 pure relievers and at least 1 closer-endurance pitcher.",
